            ...
            <form class="layui-form">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="name" lay-verify="required" placeholder="请输入字典名称" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label layui-required">字典标识</label>
                    <div class="layui-input-block">
                        <input type="text" name="identify" lay-verify="required" placeholder="请输入字典标识" class="layui-input">
                    </div>
                </div>
...
<script>
    ...
    layui.use(['easyModule'], function () {
        ...
        form.on('submit', function (obj) {
            ...
            easyAdmin.ajaxPost({
                url: "{:url('admin/SystemDictType/create')}",
                data: obj.field,
