    ...
    layui.use(['easyModule'], function () {
        ...
        treeTable.render({
            ...
            cols: [[
                ...
                {title: "权限标识", field: 'identify'},
                {title: "打开方式", field: 'target', toolbar: '#target', width: 110},
                {title: "菜单类型", field: 'type', toolbar: '#type', width: 100},
                {title: "日志记录", field: 'record', toolbar: '#record', width: 100},
                {title: '菜单排序', field: 'sort', width: 100, edit: "text"},
