...
-- Date: Sun, 25 May 2025 19:47:33 +0800
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统登录日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
SET autocommit=0;
INSERT INTO `system_dict_data` VALUES (1,1,'登录成功','127.0.0.1',1,'2025-05-25 18:12:05','2025-05-25 18:12:05');
/*!40000 ALTER TABLE `system_dict_data` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `system_dict_data` with 1 row(s)
--
...
SET autocommit=0;
INSERT INTO `system_dict_type` VALUES (1,1,'登录成功','127.0.0.1',1,'2025-05-25 18:12:05','2025-05-25 18:12:05');
/*!40000 ALTER TABLE `system_dict_type` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `system_dict_type` with 1 row(s)
--
...
SET autocommit=0;
INSERT INTO `system_login_log` VALUES (1,1,'登录成功','127.0.0.1',1,'2025-05-25 18:12:05','2025-05-25 18:12:05');
/*!40000 ALTER TABLE `system_login_log` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `system_login_log` with 1 row(s)
--
...
SET autocommit=0;
INSERT INTO `system_manager` VALUES (1,1,'/upload/image/20231024/47220acdd326647e029949627e49b197.jpg','黎明','admin','21232f297a57a5a743894a0e4a801fc3',1,2,0,'2025-05-25 18:12:05','2022-11-06 14:29:39','2025-05-25 18:12:05'),(10,6,'/upload/image/20231024/cafe4106049840244c2ffd34e7d0de4a.jpg','测试管理员','test','098f6bcd4621d373cade4e832627b4f6',1,2,0,'2025-05-15 21:19:25','2022-11-06 14:29:39','2025-05-15 21:19:25');
...
SET autocommit=0;
INSERT INTO `system_manager_role` VALUES (1,'超级管理员','super','75,128,141,161,162,163,72,73,81,85,86,74,82,83,84,1,114,121,122,150,151,152,145,99,2,159,160,69,76,80,79,134,142,157,153,154,155,156,158,143,144,147,137,136,138,148,149','拥有最高权限',10,2,'2022-11-06 14:28:28','2025-05-25 19:36:42'),(5,'普通管理员','common','75,128,141,72,73,81,85,86,74,82,83,84,1,114,121,122,150,151,152,145,99,2,69,76,80,79,134,142,157,153,154,155,156,158,143,144,147,137,136,138,148,149','普通权限',20,2,'2022-11-06 14:28:28','2025-05-15 21:17:31'),(6,'部门管理员','department','75,128,141,72,73,81,85,86,74,82,83,84','部门管理员',30,2,'2022-11-06 14:28:28','2025-05-15 21:17:35');
...
CREATE TABLE `system_menu` (
  ...
  `updateTime` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`menuId`)
) ENGINE=InnoDB AUTO_INCREMENT=164 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `system_oper_log` (
  ...
  `updateTime` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`logId`)
) ENGINE=InnoDB AUTO_INCREMENT=205 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `system_setting` (
  ...
  `value` text COLLATE utf8mb4_unicode_ci COMMENT '设置键值',
...
-- Dump completed on: Sun, 25 May 2025 19:47:33 +0800
