...
-- Date: Fri, 11 Apr 2025 15:21:37 +0800
...
--
-- Table structure for table `easy_queue_jobs`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `easy_queue_jobs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='队列数据';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `easy_queue_jobs`
--

LOCK TABLES `easy_queue_jobs` WRITE;
/*!40000 ALTER TABLE `easy_queue_jobs` DISABLE KEYS */;
SET autocommit=0;
/*!40000 ALTER TABLE `easy_queue_jobs` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `easy_queue_jobs` with 0 row(s)
--
...
CREATE TABLE `easy_system_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=88 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统登录日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `easy_system_manager`
--

LOCK TABLES `easy_system_manager` WRITE;
/*!40000 ALTER TABLE `easy_system_manager` DISABLE KEYS */;
SET autocommit=0;
INSERT INTO `easy_system_manager` VALUES (1,1,'/upload/image/20231024/47220acdd326647e029949627e49b197.jpg','黎明','admin','21232f297a57a5a743894a0e4a801fc3',1,2,0,'2025-04-11 13:54:41','2022-11-06 14:29:39','2025-04-11 14:14:32'),(10,6,'/upload/image/20231024/cafe4106049840244c2ffd34e7d0de4a.jpg','测试管理员','test','098f6bcd4621d373cade4e832627b4f6',1,2,0,NULL,'2022-11-06 14:29:39','2024-04-09 17:40:07');
/*!40000 ALTER TABLE `easy_system_manager` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `easy_system_manager` with 2 row(s)
--

--
-- Table structure for table `easy_system_manager_role`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `easy_system_manager_role` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
--
-- Dumping data for table `easy_system_manager_role`
--

LOCK TABLES `easy_system_manager_role` WRITE;
/*!40000 ALTER TABLE `easy_system_manager_role` DISABLE KEYS */;
SET autocommit=0;
INSERT INTO `easy_system_manager_role` VALUES (1,'超级管理员','super','75,128,141,64,1,99,114,121,122,150,151,152,72,73,81,85,86,74,82,83,84,145,2,69,76,80,79,134,142,157,153,154,155,156,158,143,144,147,137,136,138,148,149','拥有最高权限',0,2,'2022-11-06 14:28:28','2024-03-28 15:45:03'),(5,'普通管理员','common','75,128,141,158,64,1,99,114,121,122,150,151,152,72,73,81,85,86,74,82,83,84,145,2,69,76,80,79,134,142,157,153,154,155,156,143,144,147,137,136,138,148,149','普通权限',0,2,'2022-11-06 14:28:28','2024-06-24 15:07:35'),(6,'部门管理员','department','75,128,141,158,64,1,99,114,121,122,150,151,152,72,73,81,85,86,74,82,83,84,145,2,69,76,80,79,134,142,157,153,154,155,156,143,144,147,137,136,138,148,149','部门管理员',0,2,'2022-11-06 14:28:28','2023-11-28 09:04:09');
/*!40000 ALTER TABLE `easy_system_manager_role` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `easy_system_manager_role` with 3 row(s)
--
...
SET autocommit=0;
INSERT INTO `easy_system_setting` VALUES (1,'EASYADMIN','PHP后台快速开发系统','111','2023-10-24 10:33:41','2024-07-31 14:01:27');
...
-- Dump completed on: Fri, 11 Apr 2025 15:21:37 +0800
