...
-- Date: Sun, 07 Aug 2022 10:52:08 +0800
...
CREATE TABLE `easy_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=156 DEFAULT CHARSET=utf8mb4 COMMENT='系统日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `easy_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=142 DEFAULT CHARSET=utf8mb4 COMMENT='系统节点';
/*!40101 SET character_set_client = @saved_cs_client */;
...
SET autocommit=0;
INSERT INTO `easy_menu` VALUES (1,64,'系统管理','fa-cogs','admin','','','',1,'',1,10),(2,1,'系统设置','fa-cog','admin','setting','system','',1,'',1,0),(64,0,'系统模块','fa fa-fw fa-cogs','admin','','','',1,'',1,20),(69,1,'菜单设置','fa-bars','admin','menu','index','',1,'',1,0),(72,64,'权限管理','fa-users','admin','','','',1,'',1,10),(73,72,'管理员','fa-user','admin','manager','index','',1,'',1,10),(74,72,'角色管理','fa-user-plus','admin','role','index','',1,'',1,10),(75,0,'系统主页','fa-home','admin','index','index','',1,'',1,10),(76,69,'菜单添加','fa-plus','admin','menu','create','',2,'',1,10),(79,69,'菜单删除','fa-trash','admin','menu','delete','',2,'',1,30),(80,69,'菜单修改','fa-edit','admin','menu','update','',2,'',1,20),(81,73,'管理员添加','fa-plus','admin','manager','create','',2,'',1,10),(82,74,'角色添加','fa-plus','admin','role','create','',2,'',1,10),(83,74,'角色修改','fa-edit','admin','role','update','',2,'',1,20),(84,74,'角色删除','fa-trash','admin','role','delete','',2,'',1,30),(85,73,'管理员修改','fa-edit','admin','manager','update','',2,'',1,10),(86,73,'管理员删除','fa-trash','admin','manager','delete','',2,'',1,10),(99,75,'门户统计','fa-bar-chart','admin','home','dashboard','',1,'https://www.baidu.com/',1,20),(114,1,'系统日志','fa-book','admin','log','index','',1,'',1,30),(121,114,'日志详情','fa-eye','admin','log','detail','',2,'',1,10),(122,114,'日志清空','fa-close','admin','log','clear','',2,'',1,20),(128,75,'控制台','fa-dashboard','admin','home','console','',1,'',1,10),(134,69,'菜单排序','fa-sort','admin','menu','sort','',2,'',1,100),(136,137,'系统信息','fa-link','admin','index','system','',2,'',1,100),(137,0,'其他菜单','fa-folder-open','admin','','','',2,'',1,100),(138,137,'个人资料','fa-link','admin','index','profile','',2,'',1,100),(139,72,'部门管理','fa-archive','admin','department','index','',1,'',1,100),(140,139,'部门添加','fa-link','admin','department','create','',2,'',1,100),(141,75,'UI组件','fa-pie-chart','admin','home','components','',1,'',1,100);
/*!40000 ALTER TABLE `easy_menu` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `easy_menu` with 29 row(s)
--
...
-- Dumped table `easy_permission` with 59 row(s)
--
...
-- Dump completed on: Sun, 07 Aug 2022 10:52:08 +0800
