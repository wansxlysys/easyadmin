...
-- Date: Thu, 19 Jan 2023 16:04:16 +0800
...
CREATE TABLE `easy_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=199 DEFAULT CHARSET=utf8mb4 COMMENT='系统日志';
...
SET autocommit=0;
INSERT INTO `easy_manager` VALUES (1,1,'/uploads/images/20220227/024757163b86acf4fe41710642fd1d54.jpg','黎明','admin','21232f297a57a5a743894a0e4a801fc3',1,1,'2022-11-06 14:29:39','2022-11-06 14:29:39'),(10,5,'/uploads/images/20220227/047f8122f2040b206ba8ee713e6c235d.jpg','测试管理员','test','098f6bcd4621d373cade4e832627b4f6',2,1,'2022-11-06 14:29:39','2023-01-19 16:03:52');
...
CREATE TABLE `easy_menu` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=150 DEFAULT CHARSET=utf8mb4 COMMENT='系统节点';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on: Thu, 19 Jan 2023 16:04:16 +0800
