...
(312, 1, '菜单删除', '系统自动记录：删除成功', '/admin/menu/delete.html', '{\"id\":\"151\"}', 1, '2023-04-06 14:01:49');
...
(1, 1, '/uploads/images/20230320/6811572f7034ef16dc02f0447c3dfe2a.jpg', '黎明', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, 1, '2023-04-06 14:02:23', '2022-11-06 14:29:39', '2023-04-06 14:02:23'),
...
(15, 1, '登录成功', '127.0.0.1', 1, '2023-04-06 13:54:01', '2023-04-06 13:54:01'),
(16, 1, '登录成功', '127.0.0.1', 1, '2023-04-06 14:02:23', '2023-04-06 14:02:23');
...
--
ALTER TABLE `easy_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=313;
